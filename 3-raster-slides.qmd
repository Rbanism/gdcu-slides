...
## Types of raster data - Continuous

:::: {.columns}

::: {.column width="50%"}

![DEM of Mt. Everest Region (source: Wikipedia, 2025)](fig/elevation.png){width=100%}

:::

::: {.column width="50%"}

![Temperature map of London (source: -)](fig/temperature.png){width=100%}

:::

::::

## Types of raster data - Discrete

![land use in the Netherlands, 2015 (Source: CBS)](fig/categorical.png)
